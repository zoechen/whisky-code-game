          ...
          <a-row :gutter="[4, 16]">
            <a-col :span="12">
              <a-checkbox value="100000">
                <a-card :class="selected.includes('100000') ? 'active' : 'normal'" style="width: 40vw;">可可果肉</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="12">
    ...
    <a-row :gutter="[4, 16]">
      ...
      <a-col :span="24"><p class="result"> <span v-if="counter > 0">恭喜獲得{{ counter }},<br/></span>目前累積金額{{ nowscore }}</p></a-col>
        ...
        <a-row :gutter="[4, 16]">
          <a-col :span="12">
              <a-checkbox value="100000">
                <a-card :class="selected.includes('100000') ? 'active' : 'normal'" style="width: 40vw;">可可果肉<br/>100000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="12">
              <a-checkbox value="100">
