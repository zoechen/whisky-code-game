    ...
    <div v-if="game=='wineDrinkQ'">
      ...
      <a-form :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
        <a-checkbox-group v-model:value="selected" >
          <a-row :gutter="[4, 16]">
            <a-col :span="8">
              <a-checkbox value="500001">
                <a-card :class="selected.includes('500001') ? 'active' : 'normal'">檸檬</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="20">
            ...
            <a-col :span="8">
              <a-checkbox value="500002">
                <a-card :class="selected.includes('500002') ? 'active' : 'normal'">伯爵茶</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="30">
            ...
            <a-col :span="8">
              <a-checkbox value="500003">
                <a-card :class="selected.includes('500003') ? 'active' : 'normal'">佛手柑</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="500004">
                <a-card :class="selected.includes('500004') ? 'active' : 'normal'">金桔</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="60">
            ...
            <a-col :span="8">
              <a-checkbox value="50">
                <a-card :class="selected.includes('50') ? 'active' : 'normal'">接骨木</a-card>
              </a-checkbox>
            </a-col>  
          </a-row>
        </a-checkbox-group>
      ...
      <a-form :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
        <a-checkbox-group disabled>
          <a-row :gutter="[4, 16]">
            <a-col :span="8">
              <a-checkbox value="500001">
                <a-card :class="selected.includes('500001') ? 'active' : 'normal'">檸檬<br/>500,000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="20">
            ...
            <a-col :span="8">
              <a-checkbox value="100002">
                <a-card :class="selected.includes('500002') ? 'active' : 'normal'">伯爵茶<br/>500,000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="30">
            ...
            <a-col :span="8">
              <a-checkbox value="500003">
                <a-card :class="selected.includes('500003') ? 'active' : 'normal'">佛手柑<br/>500,000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="500004">
                <a-card :class="selected.includes('500004') ? 'active' : 'normal'">金桔<br/>500,000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="60">
            ...
            <a-col :span="8">
              <a-checkbox value="50">
                <a-card :class="selected.includes('50') ? 'active' : 'normal'">接骨木<br/>X</a-card>
              </a-checkbox>
            </a-col> 
          </a-row>
        </a-checkbox-group>
      ...
      <a-form :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
        <a-checkbox-group v-model:value="selected" >
          <a-row :gutter="[4, 16]">
            <a-col :span="8">
              <a-checkbox value="500001">
                <a-card :class="selected.includes('500001') ? 'active' : 'normal'">阿薩姆紅茶</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="500002">
            ...
            <a-col :span="8">
              <a-checkbox value="500004">
                <a-card :class="selected.includes('500004') ? 'active' : 'normal'">蘋果</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="30">
            ...
            <a-col :span="8">
              <a-checkbox value="500003">
                <a-card :class="selected.includes('500003') ? 'active' : 'normal'">葡萄柚</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="70">
                <a-card :class="selected.includes('70') ? 'active' : 'normal'">蜂蜜</a-card>
              </a-checkbox>
            </a-col>
          </a-row>
        </a-checkbox-group>
      ...
      <a-form :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }">
        <a-checkbox-group disabled>
          <a-row :gutter="[4, 16]">
            <a-col :span="8">
              <a-checkbox value="500001">
                <a-card :class="selected.includes('500001') ? 'active' : 'normal'">阿薩姆紅茶<br/>500,000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="500002">
            ...
            <a-col :span="8">
              <a-checkbox value="500004">
                <a-card :class="selected.includes('500004') ? 'active' : 'normal'">蘋果<br/>500,000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="30">
            ...
            <a-col :span="8">
              <a-checkbox value="500003">
                <a-card :class="selected.includes('500003') ? 'active' : 'normal'">葡萄柚<br/>500,000</a-card>
              </a-checkbox>
            </a-col>
            <a-col :span="8">
              <a-checkbox value="70">
                <a-card :class="selected.includes('70') ? 'active' : 'normal'">蜂蜜<br/>X</a-card>
              </a-checkbox>
            </a-col>
          </a-row>
        </a-checkbox-group>
